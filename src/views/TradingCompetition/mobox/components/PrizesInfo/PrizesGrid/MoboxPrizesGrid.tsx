...
import { Tiers, mboxPrizes } from 'config/constants/trading-competition/prizes'
...
const MoboxPrizesGrid = () => {
  const [tab, setTab] = useState(0)
  const { t } = useTranslation()
  const rows = mboxPrizes[tab + 1]
  ...
  return (
    <Box pt="24px">
      <TabMenu activeIndex={tab} onItemClick={handleItemClick}>
        {Object.keys(mboxPrizes).map((team) => {
...
export default MoboxPrizesGrid
