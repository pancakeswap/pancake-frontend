  ...
  return (
    <Flex>
      <Box position="relative" mr="4px">
        ...
        <BallTextWrapper>
          <BallText bold>{reversedNumber[0]}</BallText>
        </BallTextWrapper>
      </Box>
      <Box position="relative" mr="4px">
        <LilacBall width="32px" height="32px" />
        <BallTextWrapper>
          <BallText bold>{reversedNumber[1]}</BallText>
        </BallTextWrapper>
      </Box>
      <Box position="relative" mr="4px">
        <TealBall width="32px" height="32px" />
        <BallTextWrapper>
          <BallText bold>{reversedNumber[2]}</BallText>
        </BallTextWrapper>
      </Box>
      <Box position="relative" mr="4px">
        <AquaBall width="32px" height="32px" />
        <BallTextWrapper>
          <BallText bold>{reversedNumber[3]}</BallText>
        </BallTextWrapper>
      </Box>
      <Box position="relative" mr="4px">
        <GreenBall width="32px" height="32px" />
        <BallTextWrapper>
          <BallText bold>{reversedNumber[4]}</BallText>
        </BallTextWrapper>
      </Box>
      <Box position="relative" mr="4px">
        <YellowBall width="32px" height="32px" />
        <BallTextWrapper>
          <BallText bold>{reversedNumber[5]}</BallText>
        </BallTextWrapper>
      </Box>
    </Flex>
  )
