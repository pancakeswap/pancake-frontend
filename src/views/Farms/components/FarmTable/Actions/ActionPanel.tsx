...
import { LinkExternal, Text, Link } from 'greenteaswap-ui-kit'
...
import { BASE_EXCHANGE_URL, BSC_SCAN } from '../../../../../config'
...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({ details, apr, multiplier, liquidity }) => {
  ...
  const bsc = `${BSC_SCAN}/address/${lpAddress}`
  ...
  return (
    <Container>
      <InfoContainer>
        <StakeContainer>
          Stake:
          <StyledLinkExternal href={`${BASE_EXCHANGE_URL}/#/add/${liquidityUrlPathParts}`}>
            {lpLabel}
          </StyledLinkExternal>
        </StakeContainer>
