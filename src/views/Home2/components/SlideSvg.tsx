...
export const SlideSvgLight: React.FC<SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 1660 339" {...props}>
      ...
      />
      <defs>
        <linearGradient id="paint0_linear" x1="830" y1="84" x2="830" y2="339" gradientUnits="userSpaceOnUse">
...
export const SlideSvgDark: React.FC<SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 1660 339" {...props}>
      ...
      />
      <defs>
        <linearGradient id="paint0_linear" x1="830" y1="83.5" x2="830" y2="338.5" gradientUnits="userSpaceOnUse">
          <stop stopColor="#08060B" stopOpacity="0.2" />
          <stop offset="0.545554" stopColor="#b2a6c3" stopOpacity="0.5" />
