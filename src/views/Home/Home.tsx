...
const Home: React.FC = () => {
  ...
  // const allocPoints = web3.eth.abi.encodeParameter('uint256', '500')
  // const lpToken = web3.eth.abi.encodeParameter('address', '0x0664C463205356246edF8f1770EA9bC14A648d62').replace('0x','')
