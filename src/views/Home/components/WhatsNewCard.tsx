  ...
  return (
    <StyledTotalValueLockedCard>
      <CardBody>
        ...
        <>
          <Row>
            <Text fontSize='14px'>1. Our second PATIENT-ZERO NFT is currently being auctioned in the Mausoleum.</Text>
          </Row>
          <Row>
          ...
          <Row>
            <Text fontSize='14px'>4. Emperor grave is out now! Multiplier graves coming Monday, you will deposit your RugZombie Common NFTs to gain access.</Text>
          </Row>
          <Row>
