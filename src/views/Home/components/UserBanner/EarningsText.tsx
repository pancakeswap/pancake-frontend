...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and WANO pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and WANO pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from WANO pool', data)
  }
