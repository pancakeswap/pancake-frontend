...
import { Heading, CardBody, CardFooter, PancakeRoundIcon, TicketRound } from 'greenteaswap-ui-kit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} TEA`)}
