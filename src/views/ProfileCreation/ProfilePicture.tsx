        ...
        <CardBody>
          ...
          <NftWrapper>
            {nfts.map((walletNft) => {
              ...
              const address = walletNft.collection.id
              return (
                <SelectionCard
                  name="profilePicture"
                  key={walletNft.tokenId}
                  value={firstTokenId}
                  // TODO: Get image from metadata once user NFT types consolidated.
                  image={`/images/nfts/${walletNft.tokenId}`}
                  isChecked={firstTokenId === selectedNft.tokenId}
                  onChange={(value: string) => actions.setSelectedNft(value, address)}
                >
                  {/* TODO: Get from metadata once user NFT types consolidated. */}
