...
const TimeLine = () => {
  ...
  return (
    <div id='Timeline' className="bog-buy-background" style={{width: "100%", paddingTop: isDesktop ? "0px" : "80px", height: isDesktop ? '1200px' : '1280px'}}>
      <Flex justifyContent="center">
        <iframe
          src='https://app.bogged.finance/swap?tokenIn=BNB&tokenOut=0x50ba8bf9e34f0f83f96a340387d1d3888ba4b3b5&embed=1'
          height="873px"  title='BUY $ZMBE now using BogSwap'
