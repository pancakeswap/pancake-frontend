...
const ifos: Ifo[] = [
  {
    id: 'era',
    address: '0x9F89422bE986a4E994415Db7F71758FD003716A1',
    isActive: true,
    name: 'IFO 3.1 CM Test',
    poolBasic: {
      saleAmount: '2 BUSD',
      raiseAmount: '$1.65',
      cakeToBurn: '$0',
    ...
    tokenOfferingPrice: 0.825,
    version: 3.1,
    telegramUrl: 'https://t.me/PancakeSwap',
    twitterUrl: 'https://twitter.com/pancakeswap',
    description:
      'Community test of IFO 3.1. The only place you can buy BUSD with a price of $0.825. For private sale, you will need a PancakeBunnies NFT as profile avatar.',
  },
  {
    id: 'froyo',
