...
export interface BoosterProxyFactoryInterface extends utils.Interface {
  functions: {
...
export interface BoosterProxyFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BoosterProxyFactoryInterface;
