...
export interface TradingCompetitionEasterInterface extends utils.Interface {
  functions: {
...
export interface TradingCompetitionEaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TradingCompetitionEasterInterface;
