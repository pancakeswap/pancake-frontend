...
export interface CakePredictionsInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "NewKeeperAddress(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewKeeperAddress"): EventFragment;
...
export type NewKeeperAddressEvent = TypedEvent<[string], { operator: string }>;

export type NewKeeperAddressEventFilter =
  TypedEventFilter<NewKeeperAddressEvent>;
...
export interface CakePredictions extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CakePredictionsInterface;
  ...
  callStatic: {
    ...
    setKeeper(_keeperAddress: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "NewKeeperAddress(address)"(operator?: null): NewKeeperAddressEventFilter;
    NewKeeperAddress(operator?: null): NewKeeperAddressEventFilter;
