...
import type {
  CakePredictions,
  CakePredictionsInterface,
} from "../CakePredictions";
...
export class CakePredictions__factory {
  static readonly abi = _abi;
  static createInterface(): CakePredictionsInterface {
    return new utils.Interface(_abi) as CakePredictionsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CakePredictions {
    return new Contract(address, _abi, signerOrProvider) as CakePredictions;
  }
}
