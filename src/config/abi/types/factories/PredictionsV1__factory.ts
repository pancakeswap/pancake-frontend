...
import type { PredictionsV1, PredictionsV1Interface } from "../PredictionsV1";
...
export class PredictionsV1__factory {
  static readonly abi = _abi;
  static createInterface(): PredictionsV1Interface {
    return new utils.Interface(_abi) as PredictionsV1Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PredictionsV1 {
    return new Contract(address, _abi, signerOrProvider) as PredictionsV1;
  }
}
