...
export class PotteryDrawAbi__factory {
  static readonly abi = _abi;
  static createInterface(): PotteryDrawAbiInterface {
    return new utils.Interface(_abi) as PotteryDrawAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PotteryDrawAbi {
    return new Contract(address, _abi, signerOrProvider) as PotteryDrawAbi;
  }
}
