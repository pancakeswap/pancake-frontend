...
import type {
  CrossFarmingSender,
  CrossFarmingSenderInterface,
} from "../CrossFarmingSender";
...
const _abi = [
  {
    inputs: [
      ...
      },
      {
        ...
        name: "_oracle_bnb_update_buffer",
        type: "uint256",
      },
      {
        internalType: "uint256",
        name: "_oracle_eth_update_buffer",
        type: "uint256",
      },
      {
        internalType: "uint64",
...
export class CrossFarmingSender__factory {
  static readonly abi = _abi;
  static createInterface(): CrossFarmingSenderInterface {
    return new utils.Interface(_abi) as CrossFarmingSenderInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CrossFarmingSender {
    return new Contract(address, _abi, signerOrProvider) as CrossFarmingSender;
  }
}
