...
import { APT, CE_USDC, L0_USDC, WH_USDC, CAKE, CE_BNB } from 'config/coins'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [L0_USDC[ChainId.MAINNET], CAKE[ChainId.MAINNET], CE_BNB[ChainId.MAINNET]],
  [ChainId.TESTNET]: [L0_USDC[ChainId.TESTNET], CAKE[ChainId.TESTNET], CE_BNB[ChainId.MAINNET]],
}
