...
export const CHAIN_REFRESH_TIME = {
  ...
  [ChainId.PULSECHAIN]: 6_000,
  [ChainId.BASE]: 6_000,
  [ChainId.DEGENCHAIN]: 6_000,
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.PULSECHAIN]: [pulseTokens.usdc, pulseTokens.weth, pulseTokens.dai],
  [ChainId.BASE]: [baseTokens.usdc, baseTokens.weth, baseTokens.dai],
  [ChainId.DEGENCHAIN]: [degenTokens.weth],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.PULSECHAIN]: [
    [pulseTokens.usdc, pulseTokens.weth],
    [pulseTokens.dai, pulseTokens.weth],
    [pulseTokens.cake, pulseTokens.weth],
  ],
  [ChainId.BASE]: [
    [baseTokens.usdc, baseTokens.weth],
    [baseTokens.dai, baseTokens.weth],
    [baseTokens.cake, baseTokens.weth],
  ],
  [ChainId.DEGENCHAIN]: [[degenTokens.cake, degenTokens.weth]],
  [ChainId.BASE_TESTNET]: [[baseTestnetTokens.usdc, baseTestnetTokens.weth]],
  [ChainId.SCROLL_SEPOLIA]: [[scrollSepoliaTokens.usdc, scrollSepoliaTokens.weth]],
}
