...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.POLYGON_ZKEVM_TESTNET]: [polygonZkEvmTestnetTokens.weth, polygonZkEvmTestnetTokens.usdt, polygonZkEvmTestnetTokens.usdc],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.POLYGON_ZKEVM]: [
    [polygonZkEvmTokens.weth, polygonZkEvmTokens.usdt],
    [polygonZkEvmTokens.weth, polygonZkEvmTokens.usdc],
  ],
  [ChainId.ZKSYNC]: [[zksyncTokens.usdc, zksyncTokens.weth]],
  [ChainId.ZKSYNC_TESTNET]: [[zkSyncTestnetTokens.usdc, zkSyncTestnetTokens.weth]],
  [ChainId.LINEA_TESTNET]: [[lineaTestnetTokens.usdc, lineaTestnetTokens.weth]],
