...
export const POOLS_FAST_REVALIDATE = {
  ...
  [ChainId.POLYGON_ZKEVM]: 30_000,
  [ChainId.POLYGON_ZKEVM_TESTNET]: 30_000,
...
export const POOLS_NORMAL_REVALIDATE = {
  ...
  [ChainId.POLYGON_ZKEVM]: 45_000,
  [ChainId.POLYGON_ZKEVM_TESTNET]: 45_000,
...
export const POOLS_SLOW_REVALIDATE = {
  ...
  [ChainId.POLYGON_ZKEVM]: 60_000,
  [ChainId.POLYGON_ZKEVM_TESTNET]: 60_000,
