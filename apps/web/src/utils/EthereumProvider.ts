...
export declare namespace PushClientTypes {
  type Event = 'push_response' | 'push_proposal' | 'push_subscription' | 'push_message' | 'push_delete' | 'push_update'
...
export interface IPushClientEvents {
  emit: <E extends PushClientTypes.Event>(event: E, args: PushClientTypes.EventArguments[E]) => boolean

  on: <E extends PushClientTypes.Event>(
    event: E,
    listener: (args: PushClientTypes.EventArguments[E]) => void,
  ) => EventEmitter

  pnce: <E extends PushClientTypes.Event>(
    event: E,
    listener: (args: PushClientTypes.EventArguments[E]) => void,
  ) => EventEmitter

  off: <E extends PushClientTypes.Event>(
    event: E,
    listener: (args: PushClientTypes.EventArguments[E]) => void,
  ) => EventEmitter

  removeListener: <E extends PushClientTypes.Event>(
    event: E,
    listener: (args: PushClientTypes.EventArguments[E]) => void,
  ) => EventEmitter
}
...
export interface PushClientProvider {
  // connection event
  on(event: 'push_response', listener: (info: any) => void): any
  // disconnection event
  on(event: 'push_delete', listener: (error: ProviderRpcError) => void): EthereumProvider
}
...
export class EthereumProvider implements IEthereumProvider {
  ...
  protected registerPushEventListeners() {
  ...
  protected registerAuthEventListeners() {
  ...
  protected async initialize(opts: EthereumProviderOptions) {
    ...
    this.chainId = this.rpc.chains.length
      ...
      const cl = await SignClient.init({
            core,
            projectId,
    ...
    this.registerPushEventListeners()
