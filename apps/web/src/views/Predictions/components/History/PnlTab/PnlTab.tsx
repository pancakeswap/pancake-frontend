...
import { Box, Flex, Heading, Text, Button, LinkExternal, OpenNewIcon } from '@pancakeswap/uikit'
    ...
    <Box p="16px">
      ...
      <Box pl="8px">
        ...
        <Flex justifyContent="center" mt="24px">
          <LinkExternal href={`${getBlockExploreLink(account, 'address')}#internaltx`} mb="16px" isBscScan>
