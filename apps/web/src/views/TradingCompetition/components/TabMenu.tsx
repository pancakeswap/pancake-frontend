...
const TabMenu = () => {
  ...
  const [finishedActive, setIsAchievementsActive] = useState(pathname.includes('finished'))

  useEffect(() => {
    setIsAchievementsActive(pathname.includes('finished'))
  }, [pathname])
