...
const CheckPrizesSection = () => {
  ...
  const getBody = () => {
    ...
    if (hasCheckedForRewards && !hasRewardsToClaim) {
      return (
        <Flex alignItems="center" justifyContent="center">
          <TornTicketImage src="/images/lottery/cadinu_ticket_1.svg" alt="torn lottery ticket" />
          ...
          <TornTicketImage src="/images/lottery/cadinu_ticket_2.svg" alt="torn lottery ticket" />
        </Flex>
      )
    }
    if (hasCheckedForRewards && hasRewardsToClaim) {
