...
export const VeCakePreview: React.FC<React.PropsWithChildren<VeCakePreviewProps>> = ({
  ...
  const { status, cakeLockExpired, cakeLocked, cakePoolLocked, cakePoolLockExpired } = useCakeLockStatus()
  ...
  return (
    <Flex flexDirection={['column']}>
      ...
      {status === CakeLockStatus.NotLocked || !cakeLocked || (cakePoolLocked && !cakePoolLockExpired) ? (
