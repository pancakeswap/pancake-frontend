...
export const withHarvestHandler =
  (CollectModalComp: (props: Pool.CollectModalWithHandlerProps) => ReactElement) =>
  ({ earningTokenSymbol, sousId, isBnbPool, onDismiss, ...rest }: React.PropsWithChildren<Pool.CollectModalProps>) => {
...
export default withHarvestHandler(Pool.CollectModal)
