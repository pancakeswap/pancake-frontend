...
import { launchpadBaseUrl } from 'views/Nft/market/constants'
import { Collection } from 'state/nftMarket/types'
import { useTranslation } from '@pancakeswap/localization'
import { CollectionCard } from '../components/CollectibleCard'
import { BNBAmountLabel } from '../components/CollectibleCard/styles'

const Project: React.FC<React.PropsWithChildren<{ title: string; testId: string; collections: Collection[] }>> = ({
  title,
  testId,
  collections,
}) => {
    ...
    <>
      <Flex alignItems="center" justifyContent="space-between" mb="32px">
        ...
        <Button
          ...
          to={`${launchpadBaseUrl}/collections/`}
          variant="secondary"
          scale="sm"
        ...
        {collections.slice(0, 6).map((collection) => {
          return (
            <CollectionCard
              ...
              url={`${launchpadBaseUrl}/collections/${collection.address}`}
            >
