...
export const useAccountEventListener = () => {
  ...
  useEffect(() => {
    if (address && connector) {
      ...
      connector.onDisconnect = handleDeactiveEvent
      connector.onChainChanged = handleUpdateEvent

      return () => {
        connector.onDisconnect = () => undefined
        connector.onChainChanged = () => undefined
      }
    }
    return undefined
