...
export const usePairTokensPrice = (
  ...
  const token0Price = usePairPriceChartTokenData(token0Address, duration, chianId)
  const token1Price = usePairPriceChartTokenData(token1Address, duration, chianId)
