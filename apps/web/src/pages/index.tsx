...
export const getStaticProps: GetStaticProps = async () => {
  ...
  try {
    ...
    if (
      totalTx?.betterXFactory?.totalTransactions &&
      totalTx30DaysAgo?.betterXFactory?.totalTransactions &&
      parseInt(totalTx.betterXFactory.totalTransactions) > parseInt(totalTx30DaysAgo.betterXFactory.totalTransactions)
    ) {
