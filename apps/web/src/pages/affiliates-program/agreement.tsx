    ...
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          ...
          users (“Referrals”) to register and trade on PancakeSwap, in accordance with the terms of this Agreement.
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          (a) 3% on trading fees paid by your Referrals on PancakeSwap V2 and PancakeSwap V3, limited to swap trades on
          the BNB Smart Chain and Ethereum chain only; and
        </Text>
        <Text as="p">
          (b) 3% on trading fees paid by your Referrals on StableSwap, limited to swap trades on the BNB Smart Chain
          only.
        </Text>
