...
export const wormHoleLightTheme = {
  primary: {
    '50': lightenColor('#ffffff', 0.9),
    '100': lightenColor('#ffffff', 0.8),
    '200': lightenColor('#ffffff', 0.7),
    '300': lightenColor('#ffffff', 0.6),
    '400': lightenColor('#ffffff', 0.5),
    '500': lightenColor('#ffffff', 0.4),
    '600': lightenColor('#ffffff', 0.3),
    '700': lightenColor('#ffffff', 0.2),
    '800': lightenColor('#ffffff', 0.1),
    '900': '#ffffff',
    A100: lightenColor('#ffffff', 0.8),
    A200: lightenColor('#ffffff', 0.7),
    A400: lightenColor('#ffffff', 0.5),
    A700: lightenColor('#ffffff', 0.2),
  },
  secondary: {
