    ...
    <>
      <Head>
        ...
        <meta
          ...
          content=" Earn CADINU. win it in the Lottery."
        />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content=" Cadinu - A next evolution DeFi exchange on BNB Smart Chain (BSC)" />
        <title>Bridge | CADINU</title>
      </Head>
      <NextThemeProvider>
        <StyledThemeProvider>
          <ModalProvider>
