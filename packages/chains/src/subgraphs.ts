...
export const V3_SUBGRAPHS = {
  ...
  [ChainId.SCROLL]: 'https://api.studio.thegraph.com/query/45376/exchange-v3-scroll/version/latest',
...
export const V2_SUBGRAPHS = {
  ...
  [ChainId.SCROLL]: 'https://api.studio.thegraph.com/query/45376/exchange-v2-scroll/version/latest',
}
