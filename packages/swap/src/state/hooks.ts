...
export function queryParametersToSwapState(nativeSymbol?: string, defaultOutputCurrency?: string): SwapState {
  let inputCurrency = nativeSymbol ?? DEFAULT_INPUT_CURRENCY
  let outputCurrency = defaultOutputCurrency
