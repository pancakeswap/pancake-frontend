...
import { livePools as pulseLivePools, pools as pulsePools } from './369'
...
import { livePools as degenLivePools, pools as degenPools } from './666666666'
...
export const POOLS_CONFIG_BY_CHAIN = {
  ...
  [ChainId.DEGENCHAIN]: degenPools,
  [ChainId.PULSECHAIN]: pulsePools,
...
export const LIVE_POOLS_CONFIG_BY_CHAIN = {
  ...
  [ChainId.PULSECHAIN]: pulseLivePools,
  [ChainId.DEGENCHAIN]: degenLivePools,
