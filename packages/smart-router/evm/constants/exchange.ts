...
export const SMART_ROUTER_ADDRESSES = {
  ...
  [ChainId.BASE]: '0x0D790da84956B425e6c5D8E3d311A4e553829221',
  [ChainId.DEGENCHAIN]: '0x5ce67Ab335BB91A9E230051aF0B2548E9F2c3570',
...
export const V2_ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.BASE]: '0x8A3A245Fe09796Df9432Dc5E56e04DAAE7885364',
  [ChainId.DEGENCHAIN]: '0x2bC5656AC4785283abeAFc4B35474E35f29Da204',
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.PULSECHAIN]: [pulseTokens.usdc, pulseTokens.weth],
...
export const ADDITIONAL_BASES: {
  ...
  [ChainId.PULSECHAIN]: {
    // axlusdc - USDbC
    [pulseTokens.axlusdc.address]: [pulseTokens.usdbc],
    [pulseTokens.usdbc.address]: [pulseTokens.axlusdc],
  },
  [ChainId.BASE]: {
    // axlusdc - USDbC
