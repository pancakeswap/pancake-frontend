...
This SDK facilitates interactions with the contracts in [Universal Router]. This repo is the pancakeswap variation of the original Universal-router-sdk by UniswapLabs. The PancakeSwap implementation makes the nessecary changes in order to be compataible with the Pancakeswap smart-router and other existing SDK's
