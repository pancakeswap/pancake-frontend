...
// export const CROSS_CHAIN_ONLY_SUPPORTED_CHAIN_IDS = [ChainId.POLYGON_ZKEVM] as const
export const CROSS_CHAIN_ONLY_SUPPORTED_CHAIN_IDS = [ChainId.BSC] as const
...
export const PROFILE_SUPPORTED_CHAIN_IDS = [ChainId.POLYGON_ZKEVM] as const
