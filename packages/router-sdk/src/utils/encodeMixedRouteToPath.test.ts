...
import { Pair, CurrencyAmount, Ether, Token, WETH9 } from '@pancakeswap/sdk'
import { encodeSqrtRatioX96, FeeAmount, Pool } from '@pancakeswap/v3-sdk'
  ...
  describe('mixed route', () => {
    it('packs them for exact input v3 -> v2 with wrapped ether output', () => {
      expect(encodeMixedRouteToPath(route_0_V3_1_V2_weth)).toEqual(
        '0x00000000000000000000000000000000000000010009c40000000000000000000000000000000000000002800000c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'
      )
    })

    it('packs them for exact input v3 -> v2 -> v2', () => {
      expect(encodeMixedRouteToPath(route_0_V3_weth_V2_1_V2_2)).toEqual(
        '0x00000000000000000000000000000000000000010009c4c02aaa39b223fe8d0a0e5c4f27ead9083c756cc280000000000000000000000000000000000000000000028000000000000000000000000000000000000000000003'
      )
    })

    it('packs them for exact input v3 -> v3 -> v2', () => {
      expect(encodeMixedRouteToPath(route_0_V3_1_v3_weth_V2_2)).toEqual(
        '0x00000000000000000000000000000000000000010009c400000000000000000000000000000000000000020009c4c02aaa39b223fe8d0a0e5c4f27ead9083c756cc28000000000000000000000000000000000000000000003'
      )
    })
  })
})
