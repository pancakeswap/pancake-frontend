...
const Linea: React.FC<React.PropsWithChildren<SvgProps>> = (props) => {
  return (
    <Svg width={14} height={14} viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M11.5936 5.37101C12.6186 5.37101 13.4495 4.53762 13.4495 3.50959C13.4495 2.48156 12.6186 1.64818 11.5936 1.64818C10.5686 1.64818 9.73764 2.48156 9.73764 3.50959C9.73764 4.53762 10.5686 5.37101 11.5936 5.37101Z" fill="white"/>
      </g>
      </g>
      <defs>
