...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://KiwanoSwap.io/images/tokens/${token.address[56]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://KiwanoSwap.io/images/tokens/${token.address[56]}.svg`;
        const secondarySrc = `https://KiwanoSwap.io/images/tokens/${tokens[randomTokenIndex].address[56]}.svg`;
