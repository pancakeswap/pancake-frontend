...
export const WithSelector: React.FC<{ children: React.ReactNode }> = () => {
...
export const AdjustDistance: React.FC<{ children: React.ReactNode }> = () => {
...
export const AdjustSize: React.FC<{ children: React.ReactNode }> = () => {
...
export const AdjustNumberOfParticles: React.FC<{ children: React.ReactNode }> = () => {
...
export const DisableUnderCondition: React.FC<{ children: React.ReactNode }> = () => {
  const disableWhen = () => {
    const date = new Date();
...
export const StopAndStart: React.FC<{ children: React.ReactNode }> = () => {
